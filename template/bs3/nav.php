...
<li class="dropdown">
	<a href="#" class="dropdown-toggle" data-toggle="dropdown">문제 모음<span class="caret"></span></a>
	<ul class="dropdown-menu" role="menu">
		<li><a href="<?php echo $path_fix?>problemset.php"><?php echo $MSG_PROBLEMS?></a></li>
		<li><a href="<?php echo $path_fix?>problemcategory.php"><?php echo $MSG_CATEGORY?></a></li>
	</ul>
</li>
</li>
