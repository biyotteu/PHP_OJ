...
<?php if (isset($_SESSION['administrator'])){
	...
	<li>
	<a class='btn btn-primary' href="user_list.php" target="main"><b>UserList</b></a>
<?php }
if (isset($_SESSION['administrator'])||isset($_SESSION['problem_editor'])){
?>
	<li>
		<a class='btn btn-primary' href="problem_add_page.php" target="main"><b><?php echo $MSG_ADDPROBLEM?></b></a>
<?php }
if (isset($_SESSION['administrator'])||isset($_SESSION['category_editor'])){
?>
	<li>
		<a class='btn btn-primary' href="category_add_page.php" target="main"><b><?php echo $MSG_CATEGORY.$MSG_ADD?></b></a>
<?php }
?>
	<li>
		<a class='btn btn-primary' href="category_list.php" target="main"><b><?php echo $MSG_CATEGORY.$MSG_LIST?></b></a>
<?php
...
<?php if (isset($_SESSION['administrator'])){?>
<li>
	<a class='btn btn-primary' href="change_level_page.php" target="main"><b>유저 레벨 변경</b></a>
</ol>
<?php }?>
